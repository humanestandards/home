    ...
    features:
      - title: Sensibility Standardisation
        ...
        content: >
          ...
          The Capabilities which are Inherited to all people by Design (Functional Capabilities),
          constitute the fundamental Principles of our Ethical and therefore
          Humane Standards.


          Our Common Humane Character is our Natural form of Governance, and our own Rights are Common with anything that is Humane, Artificial,and Intelligent at the same time, and in continuity (Uninterrupted by Time Constrains).
    ...
    grid_items:
      ...
      - title: 3️⃣ Ecological Solidarity
        content: >
          ...
          Solidarity as the solution to the critical issues that we face.
        content_align: left
        actions: []
        actions_align: left
        actions_width: auto
